...
export function Campus() {
  const facilities = [
    ...
    },
    {
      title: "Seminar halls & Auditoriums",
      images: [
        "https://images.unsplash.com/photo-1596522354195-e84ae3c98731?q=80&w=1187&auto=format&fit=crop",
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        {[
          ...
          <motion.div
            key={i}
            className="absolute text-[#D56B6F] dark:text-[#F6E294]
          ...
          {facilities.map((fac, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-linear-to-t
                ...
                <div className="h-1 w-0 bg-sitm-gold mt-2
                                group-hover:w-full
