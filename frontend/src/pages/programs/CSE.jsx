...
import { Cpu, Clock, Users, DollarSign, CreditCard, BookOpen, ArrowLeft } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Specialization in AI, ML, Data Science, and Software Development with cutting-edge technology and industry-relevant curriculum
            </p>
          </motion.div>
