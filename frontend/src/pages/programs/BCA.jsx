...
export function BCA() {
  ...
  const programData = {
    ...
    duration: '3 Years',
    intake: 40,
    description: 'A comprehensive course in software development and modern programming with focus on practical applications and industry readiness.',
    fees: {
      tuitionFee: '₹1,83,625',
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950">
      ...
      <section className="relative pt-36 pb-16 bg-gray-50 dark:bg-slate-950 overflow-hidden">
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          ...
          >
            <Code className="w-80 h-80 text-sitm-navy dark:text-sitm-gold" strokeWidth={1} />
          </motion.div>
          ...
          >
            <div className="flex justify-center mb-6">
              <div className="w-16 h-16 bg-sitm-maroon/10 rounded-full flex items-center justify-center">
                <Code className="w-8 h-8 text-sitm-maroon" />
              </div>
            </div>
