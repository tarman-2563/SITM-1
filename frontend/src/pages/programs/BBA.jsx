...
export function BBA() {
  ...
  const programData = {
    ...
    duration: '3 Years',
    intake: 40,
    description: 'Developing future business leaders with expertise in finance, marketing, and HR with practical industry exposure and leadership skills.',
    fees: {
      tuitionFee: '₹1,83,625',
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950">
      ...
      <section className="relative pt-36 pb-16 bg-gray-50 dark:bg-slate-950 overflow-hidden">
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          ...
          >
            <Briefcase className="w-80 h-80 text-sitm-navy dark:text-sitm-gold" strokeWidth={1} />
          </motion.div>
          ...
          >
            <div className="flex justify-center mb-6">
              <div className="w-16 h-16 bg-sitm-maroon/10 rounded-full flex items-center justify-center">
                <Briefcase className="w-8 h-8 text-sitm-maroon" />
              </div>
            </div>
