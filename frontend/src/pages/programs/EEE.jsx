...
import { Zap, Clock, Users, DollarSign, CreditCard, BookOpen, ArrowLeft } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Advanced program in power systems, control systems, renewable energy, and electrical machines with modern technology integration
            </p>
          </motion.div>
            ...
            <div className="relative h-96 bg-gradient-to-br from-sitm-navy/10 to-sitm-maroon/10 rounded-2xl overflow-hidden border-2 border-gray-200 dark:border-slate-700">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <Zap className="w-24 h-24 text-sitm-maroon/30 mx-auto mb-4" />
                  <p className="text-gray-500 dark:text-gray-400">EEE Program Image</p>
                </div>
              </div>
            </div>
          </motion.div>
